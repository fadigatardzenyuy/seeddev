...
export class HomeComponent {
  ...
  stats = [
    ...
    { industry: 'Retail', number: '$39B+', desc: 'generated by retailers using Square annually' },
    { industry: 'Beauty', number: '15M+', desc: 'appointments booked through Square every month' },
    { industry: 'Services', number: '$93B+', desc: 'paid with Square invoices globally' },
  ];
  ...
  plans = [
    {
      name: 'Free', price: '$0', period: 'per month, forever', featured: false, cta: 'Get started free',
      features: ['Point of sale', 'Free online store', 'Basic inventory', 'Standard reports', 'Free card reader', 'Email support']
    },
    {
      name: 'Plus', price: '$29', period: 'per month, per location', featured: true, cta: 'Try free for 30 days',
      features: ['Everything in Free', 'Advanced reports', 'Lower processing rates', 'Loyalty programs', 'Marketing tools', 'Priority support']
    },
    {
      name: 'Premium', price: 'Custom', period: 'contact sales for pricing', featured: false, cta: 'Contact sales',
